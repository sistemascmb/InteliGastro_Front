...
const EnEspera = () => {
  ...
  // Estado para las citas en espera
  const [citasEnEspera, setCitasEnEspera] = useState([
    {
      id: 1,
      ...
      tipoCita: 'Urgente - Dolor Abdominal',
      fecha: '2024-01-16',
      hora: '08:00',
      estado: 'En Espera'
    },
    {
      ...
      fecha: '2024-01-17',
      hora: '10:30',
      estado: 'Esperando Cupo'
    },
    {
      id: 3,
      indicadores: { urgente: false, primera_vez: false },
      paciente: {
        nombre: 'Carlos Miguel Torres',
        documento: '11223344',
        telefono: '976543210'
      },
      centro: 'Clínica María Belén - Sede Central',
      asignadoA: 'Dr. Pedro Silva Rojas',
      tipoCita: 'Control de Seguimiento',
      fecha: '2024-01-18',
      hora: '14:00',
  ...
  const citasFiltradas = citasEnEspera.filter(cita => {
  ...
  const handleUpdateCita = () => {
    setCitasEnEspera(prev => prev.map(cita =>
  ...
  const handleDeleteCita = () => {
    setCitasEnEspera(prev => prev.filter(cita => cita.id !== selectedCita.id));
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 1, px: 2, maxWidth: '100% !important' }}>
      ...
      >
        ...
        <Typography color="text.primary">En Espera</Typography>
      </Breadcrumbs>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
        ...
        <Paper sx={{ flex: 1, boxShadow: 3, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
          <SectionHeader title={`Lista de Citas en Espera (${citasFiltradas.length})`} />
      ...
      >
        <DialogTitle sx={{
          ...
          <Typography variant="h6" fontWeight="bold">Editar Cita en Espera</Typography>
              ...
              <>
                  ...
                  <ResponsiveField label="Tipo de Cita" required>
                    <FormControl fullWidth size="small">
                      ...
                      >
                        ...
                        <MenuItem value="Urgente - Dolor Abdominal">Urgente - Dolor Abdominal</MenuItem>
                        <MenuItem value="Primera Consulta">Primera Consulta</MenuItem>
                        <MenuItem value="Control de Seguimiento">Control de Seguimiento</MenuItem>
                        <MenuItem value="Emergencia Gastroenterológica">Emergencia Gastroenterológica</MenuItem>
                        <MenuItem value="Consulta Preventiva">Consulta Preventiva</MenuItem>
                      </Select>
                    </FormControl>
                  </ResponsiveField>
                  ...
                  <ResponsiveField label="Estado" required>
                    <FormControl fullWidth size="small">
                      ...
                      >
                        ...
                        <MenuItem value="Esperando Cupo">Esperando Cupo</MenuItem>
                ...
                <ResponsiveField label="Notas">
                  <TextField
                    ...
                    placeholder="Notas adicionales sobre la cita en espera..."
                    size="small"
                  />
                </ResponsiveField>
              </>
      ...
      >
        ...
        <DialogContent sx={{ p: 4, textAlign: 'center' }}>
          <Typography variant="body1">
            ¿Está seguro de que desea cancelar la cita en espera de{' '}
