...
const Finalizadas = () => {
  ...
  // Estado para las citas finalizadas
  const [citasFinalizadas, setCitasFinalizadas] = useState([
    {
      ...
      tipoCita: 'Control Gastroenterológico',
      fecha: '2024-01-15',
      hora: '09:00',
      estado: 'Completada'
    },
    ...
    },
    {
      ...
      tipoCita: 'Endoscopia Diagnóstica',
      fecha: '2024-01-13',
      hora: '14:00',
      estado: 'Completada'
    },
  ...
  const citasFiltradas = citasFinalizadas.filter(cita => {
  ...
  const handleUpdateCita = () => {
    setCitasFinalizadas(prev => prev.map(cita =>
  ...
  const handleDeleteCita = () => {
    setCitasFinalizadas(prev => prev.filter(cita => cita.id !== selectedCita.id));
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 1, px: 2, maxWidth: '100% !important' }}>
      ...
      >
        ...
        <Typography color="text.primary">Finalizadas</Typography>
      </Breadcrumbs>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
        ...
        <Paper sx={{ flex: 1, boxShadow: 3, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
          <SectionHeader title={`Lista de Citas Finalizadas (${citasFiltradas.length})`} />
              ...
              <>
                  ...
                  <ResponsiveField label="Tipo de Cita" required>
                    <FormControl fullWidth size="small">
                      ...
                      >
                        ...
                        <MenuItem value="Control Gastroenterológico">Control Gastroenterológico</MenuItem>
                        <MenuItem value="Control Post-Operatorio">Control Post-Operatorio</MenuItem>
                        <MenuItem value="Endoscopia Diagnóstica">Endoscopia Diagnóstica</MenuItem>
                ...
                <ResponsiveField label="Notas">
                  <TextField
                    ...
                    placeholder="Notas adicionales sobre la cita finalizada..."
                    size="small"
                  />
                </ResponsiveField>
              </>
      ...
      >
        ...
        <DialogContent sx={{ p: 4, textAlign: 'center' }}>
          <Typography variant="body1">
            ¿Está seguro de que desea cancelar la cita finalizada de{' '}
